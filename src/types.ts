...
export type GoalType = 'hifz' | 'murajaa' | 'alwah' | 'ijaza' | 'tajwid';
 ...
 *  - supervisor: المشرف المالي (محمد الزموري) يرى كل التلاميذ ويسجّل الأداءات فقط
 */
...
export interface Student {
  ...
  exempt: boolean;
  /** طالب متميّز (star) — يُستعمل في الفلتر العام */
  starred: boolean;
  /**
